...
train_list_path = '../VOCdevkit/VOC{}/ImageSets/Main/trainval.txt'.format(year)
with open(train_list_path) as f:
    train_list = f.read().split()
f.close()

annotation_list_dir = '../VOCdevkit/VOC{}/Annotations/'.format(year)
...
annotation_save_dir = '../VOCdevkit/VOC{}/'.format(year)
